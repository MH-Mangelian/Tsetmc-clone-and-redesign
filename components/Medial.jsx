                    ...
                    <table className='min-w-full text-center text-base font-light'>
                        ...
                        <tbody className='text-center'>
                            <tr className="border-b dark:border-neutral-500">
                                ...
                                <td className="whitespace-nowrap text-center px-2 py-3">شاخص کل</td>
                            </tr>
                            <tr className="border-b dark:border-neutral-500">
                                ...
                                <td className="whitespace-nowrap px-2 py-3">15:00</td>
                                <td className="whitespace-nowrap text-center px-2 py-3">شاخص قيمت(وزني-ارزشي)</td>
                            </tr>
                            <tr className="border-b dark:border-neutral-500">
                                ...
                                <td className="whitespace-nowrap px-2 py-3">15:00</td>
                                <td className="whitespace-nowrap text-center px-2 py-3">شاخص كل (هم وزن)</td>
                            </tr>
                            <tr className="border-b dark:border-neutral-500">
                                ...
                                <td className="whitespace-nowrap px-2 py-3">15:00</td>
                                <td className="whitespace-nowrap text-center px-2 py-3">شاخص قيمت (هم وزن)</td>
                            </tr>
                            <tr className="border-b dark:border-neutral-500">
                                ...
                                <td className="whitespace-nowrap px-2 py-3">15:00</td>
                                <td className="whitespace-nowrap text-center px-2 py-3">شاخص آزاد شناور</td>
                            </tr>
                            <tr className="border-b dark:border-neutral-500">
                                ...
                                <td className="whitespace-nowrap px-2 py-3">15:00</td>
                                <td className="whitespace-nowrap text-center px-2 py-3">شاخص بازار اول</td>
                            </tr>
                            <tr>
                                ...
                                <td className="whitespace-nowrap px-2 py-3">15:00</td>
                                <td className="whitespace-nowrap text-center px-2 py-3">شاخص بازار دوم</td>
                            </tr>
                    ...
                    <table className='min-w-full text-right text-base font-light'>
                        ...
                        <tbody>
                            <tr className="border-b dark:border-neutral-500">
                                ...
                                <td className="whitespace-nowrap px-2 py-3">وکغدیر-بین المللی توسعه معادن غدیر</td>
                            </tr>
                            ...
                            <tr className="border-b dark:border-neutral-500">
                                ...
                                <td className="whitespace-nowrap px-2 py-3">خگستر-گسترش سرمایه گذاری ایران خودرو</td>
                            </tr>
                            ...
                            <tr className="border-b dark:border-neutral-500">
                                ...
                                <td className="whitespace-nowrap px-2 py-3">شستا-سرمایه گذاری تامین اجتماعی</td>
                            </tr>
                            ...
                            <tr className="border-b dark:border-neutral-500">
                                ...
                                <td className="whitespace-nowrap px-2 py-3">فباهنر-مس شهید باهنر</td>
                            </tr>
                            ...
                            <tr className="border-b dark:border-neutral-500">
                                ...
                                <td className="whitespace-nowrap px-2 py-3">خساپا-سایپا</td>
                            </tr>
                            ...
                            <tr className="border-b dark:border-neutral-500">
                                ...
                                <td className="whitespace-nowrap px-2 py-3">خودرو-ایران خودرو</td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td className="whitespace-nowrap px-2 py-3">فملی-ملی صنایع مس ایران</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
                    ...
                    <table className='min-w-full text-right text-base font-light'>
                        ...
                        <tbody>
                            <tr className="border-b dark:border-neutral-500">
                                ...
                                <td className="whitespace-nowrap px-2 py-3">15:00</td>
                                <td className="whitespace-nowrap px-2 py-3">شاخص کل فرابورس</td>
                            </tr>
                            ...
                            <tr className="border-b dark:border-neutral-500">
                                ...
                                <td className="whitespace-nowrap px-2 py-3">15:00</td>
                                <td className="whitespace-nowrap px-2 py-3">شاخص قیمت فرابورس</td>
                            </tr>
                            ...
                            <tr class="border-b dark:border-neutral-500">
                                ...
                                <td class="whitespace-nowrap px-2 py-3">شاخص کل هم وزن فرابورس</td>
                            </tr>
                            ...
                            <tr className="border-b dark:border-neutral-500">
                                ...
                                <td className="whitespace-nowrap px-2 py-3">39,641.59</td>
                                <td className="whitespace-nowrap px-2 py-3">15:00</td>
                                <td className="whitespace-nowrap px-2 py-3">شاخص قیمت هم وزن فرابورس</td>
                            </tr>
                            ...
                            <tr className="border-b dark:border-neutral-500">
                                ...
                                <td className="whitespace-nowrap px-2 py-3">15:00</td>
                                <td className="whitespace-nowrap px-2 py-3">بازار اول فرابورس</td>
                            </tr>
                            ...
                            <tr className="">
                                ...
                                <td className="whitespace-nowrap px-2 py-3">10,888.84</td>
                                <td className="whitespace-nowrap px-2 py-3">15:00</td>
                                <td className="whitespace-nowrap px-2 py-3">بازار دوم فرابورس</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
                    ...
                    <table className='min-w-full text-right text-base font-light'>
                        <tbody>
                            ...
                            <tr className="border-b dark:border-neutral-500">
                                ...
                                <td className="whitespace-nowrap px-2 py-3"> ارزش بازار <span className='text-[10px]'>اول و دوم</span></td>
                            </tr>

                            <tr className="border-b dark:border-neutral-500">
                                <td className="whitespace-nowrap px-2 py-3">4,296,098.495 B</td>
                                <td className="whitespace-nowrap px-2 py-3">ارزش بازار <span className='text-[10px]'>پایه</span></td>
                            </tr>
                            ...
                            <tr className="">
                                ...
                                <td className="whitespace-nowrap px-2 py-3">حجم معاملات</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
                    ...
                    <table className='min-w-full text-right text-base font-light'>
                        ...
                        <tbody>
                            <tr className="border-b dark:border-neutral-500">
                                ...
                                <td className="whitespace-nowrap px-2 py-3">دی-بانک دی</td>
                            </tr>
                            ...
                            <tr className="border-b dark:border-neutral-500">
                                ...
                                <td className="whitespace-nowrap px-2 py-3">کرمان-س.توسعه استان کرمان</td>
                            </tr>
                            ...
                            <tr className="border-b dark:border-neutral-500">
                                ...
                                <td className="whitespace-nowrap px-2 py-3">وسپهر-سرمایه گذاری مالی سپهر صادرات</td>
                            </tr>
                            ...
                            <tr className="border-b dark:border-neutral-500">
                                ...
                                <td className="whitespace-nowrap px-2 py-3">گدنا-تهیه توزیع غذای دنا آفرین فدک</td>
                            </tr>
                            ...
                            <tr className="border-b dark:border-neutral-500">
                                ...
                                <td className="whitespace-nowrap px-2 py-3">خاور-ایران خودرو دیزل</td>
                            </tr>
                            ...
                            <tr className="border-b dark:border-neutral-500">
                                ...
                                <td className="whitespace-nowrap px-2 py-3">غدیس-پاکدیس</td>
                            </tr>
                            ...
                            <tr className="">
                                ...
                                <td className="whitespace-nowrap px-2 py-3">فرابورس-فرابورس ایران</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
