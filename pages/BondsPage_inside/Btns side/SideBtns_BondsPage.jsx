  ...
  return (
    <>
        ...
        <div className="grid grid-cols-4 gap-1 mx-2 text-center md:hidden max-md:mb-7 max-md:mt-1">
                  ...
                  <div className='col-span-2 font-medium bg-gradient-to-r from-cyan-600 to-cyan-900  p-2 border-1 rounded-t-lg active:shadow-md jumper-hover-btn-center'><Link to="/bonds/supply-demand">عرضه و تقاضا</Link></div>
              ...
              <div className='grid grid-flow-col auto-cols-max px-16 gap-x-2 max-md:hidden xl:flex-row xl:top-20'>
                  ...
                  <div className='inline-block font-medium bg-gradient-to-r from-pink-900 to-red-800  p-2 border-1 rounded-t-lg active:shadow-md jumper-hover-btn-center'><Link to="/bonds/supply-demand">عرضه و تقاضا</Link></div>
